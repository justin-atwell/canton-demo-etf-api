...
public class Consume extends DamlRecord<Consume> {
  public static final String _packageId = "1f28d7b7af3161c75a78b37a77e89a8c08d9579c841613879009c4365fd6566c";

  public Consume() {
  }

  public static ValueDecoder<Consume> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Consume> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Consume());
  }

  public static Consume fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.pricing.nbboquote.Consume";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Consume> get() {
      return jsonDecoder();
    }
  }
}
