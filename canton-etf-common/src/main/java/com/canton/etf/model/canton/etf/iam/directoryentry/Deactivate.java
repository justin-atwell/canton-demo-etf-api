...
public class Deactivate extends DamlRecord<Deactivate> {
  public static final String _packageId = "a2a966e2266e50a56a1ccc2c3f61201f19edb87e6611e193c1e4f4018a9c6ca2";

  public Deactivate() {
  }

  public static ValueDecoder<Deactivate> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Deactivate> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Deactivate());
  }

  public static Deactivate fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Deactivate)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.iam.directoryentry.Deactivate";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Deactivate> get() {
      return jsonDecoder();
    }
  }
}
