...
public class RejectByBroker extends DamlRecord<RejectByBroker> {
  public static final String _packageId = "a2a966e2266e50a56a1ccc2c3f61201f19edb87e6611e193c1e4f4018a9c6ca2";

  public final String reason;

  public RejectByBroker(String reason) {
    this.reason = reason;
  }

  public static ValueDecoder<RejectByBroker> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
      Value recordValue$ = value$;
      List<com.daml.ledger.javaapi.data.DamlRecord.Field> fields$ = PrimitiveValueDecoders.recordCheck(1,0,
          recordValue$);
      String reason = PrimitiveValueDecoders.fromText.decode(fields$.get(0).getValue());
      return new RejectByBroker(reason);
    } ;
  }
  ...
  public static JsonLfDecoder<RejectByBroker> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList("reason"), name -> {
        ...
        , (Object[] args) -> new RejectByBroker(JsonLfDecoders.cast(args[0])));
  }

  public static RejectByBroker fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof RejectByBroker)) {
      return false;
    }
    RejectByBroker other = (RejectByBroker) object;
  ...
  public String toString() {
    return String.format("com.canton.etf.model.canton.etf.primebrokerage.substitutionrequest.RejectByBroker(%s)",
        this.reason);
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<RejectByBroker> get() {
      return jsonDecoder();
    }
  }
}
