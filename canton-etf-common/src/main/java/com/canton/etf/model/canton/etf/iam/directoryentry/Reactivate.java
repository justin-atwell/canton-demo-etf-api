...
public class Reactivate extends DamlRecord<Reactivate> {
  public static final String _packageId = "d152e05f0163f6f98cd1bfa4dea83fe4efd885a5d3898947b1f6cd243a818b18";

  public Reactivate() {
  }

  public static ValueDecoder<Reactivate> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Reactivate> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Reactivate());
  }

  public static Reactivate fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public boolean equals(Object object) {
    ...
    if (!(object instanceof Reactivate)) {
      return false;
    }
    return true;
  }
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.iam.directoryentry.Reactivate";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Reactivate> get() {
      return jsonDecoder();
    }
  }
}
