package com.canton.etf.model.da.types;
...
public class Tuple2<t1, t2> {
  ...
  public String toString() {
    return String.format("com.canton.etf.model.da.types.Tuple2(%s, %s)", this._1, this._2);
  }
  ...
  public static class JsonDecoder$ {
    public <t1, t2> JsonLfDecoder<Tuple2<t1, t2>> get(JsonLfDecoder<t1> decodet1,
        JsonLfDecoder<t2> decodet2) {
      return jsonDecoder(decodet1, decodet2);
    }
  }
}
