...
public class Suspend extends DamlRecord<Suspend> {
  public static final String _packageId = "1f28d7b7af3161c75a78b37a77e89a8c08d9579c841613879009c4365fd6566c";

  public Suspend() {
  }

  public static ValueDecoder<Suspend> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Suspend> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Suspend());
  }

  public static Suspend fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.fund.etfdefinition.Suspend";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Suspend> get() {
      return jsonDecoder();
    }
  }
}
