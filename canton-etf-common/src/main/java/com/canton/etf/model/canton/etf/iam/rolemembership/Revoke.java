...
public class Revoke extends DamlRecord<Revoke> {
  ...
  public static ValueDecoder<Revoke> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Revoke> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Revoke());
  }

  public static Revoke fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.iam.rolemembership.Revoke";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Revoke> get() {
      return jsonDecoder();
    }
  }
}
