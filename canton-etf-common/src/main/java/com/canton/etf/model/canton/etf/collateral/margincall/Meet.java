...
public class Meet extends DamlRecord<Meet> {
  ...
  public static ValueDecoder<Meet> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Meet> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Meet());
  }

  public static Meet fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.collateral.margincall.Meet";
  }
