...
public class Default extends DamlRecord<Default> {
  public static final String _packageId = "1f28d7b7af3161c75a78b37a77e89a8c08d9579c841613879009c4365fd6566c";

  public Default() {
  }

  public static ValueDecoder<Default> valueDecoder() throws IllegalArgumentException {
    return value$ -> {
  ...
  public static JsonLfDecoder<Default> jsonDecoder() {
    return JsonLfDecoders.record(Arrays.asList(), name -> {
          switch (name) {
            default: return null;
          }
        }
        , (Object[] args) -> new Default());
  }

  public static Default fromJson(String json) throws JsonLfDecoder.Error {
  ...
  public String toString() {
    return "com.canton.etf.model.canton.etf.collateral.margincall.Default";
  }
  ...
  public static class JsonDecoder$ {
    public JsonLfDecoder<Default> get() {
      return jsonDecoder();
    }
  }
}
